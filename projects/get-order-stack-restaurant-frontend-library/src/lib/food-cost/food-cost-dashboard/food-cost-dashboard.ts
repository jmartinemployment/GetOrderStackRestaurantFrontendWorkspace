...
import { CurrencyPipe, DecimalPipe, DatePipe, PercentPipe, TitleCasePipe } from '@angular/common';
...
@Component({
  selector: 'get-order-stack-food-cost',
  standalone: true,
  imports: [CurrencyPipe, DecimalPipe, DatePipe, PercentPipe, TitleCasePipe],
